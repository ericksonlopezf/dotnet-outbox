...
public sealed class OracleOutboxRepository : IOutboxRepository
{
    ...
    public async ValueTask InsertAsync(OutboxMessage record, IOutboxTransactionContext transaction, CancellationToken cancellationToken = default)
    {
        ...
        // Stryker disable Boolean,Conditional,Block,Equality,Pattern,Statement : OracleCommand BindByName per ADR-013
    ...
    public async ValueTask MarkAsDispatchedAsync(IReadOnlyList<OutboxMessage> messages, CancellationToken cancellationToken = default)
    {
        ...
        // Stryker disable Boolean,Conditional,Block,Equality,Pattern,Statement : OracleCommand cast checked at runtime per ADR-013
        cmd.BindByName = true;
        // Stryker restore Boolean,Conditional,Block,Equality,Pattern,Statement
    ...
    {
        // Stryker disable Equality,Conditional,Boolean,Block : Defensive parameter guard per ADR-013
