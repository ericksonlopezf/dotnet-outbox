...
OUTBOX011 | Reliability | Warning | Stale lease timeout configured too low (< 30s).
...
OUTBOX013 | Configuration | Error | Message type not registered for AOT JSON serialization in JsonSerializerContext.
