...
/// <summary>
/// Provides a MariaDB implementation of <see cref="IDeadLetterRepository"/>.
/// </summary>
public sealed class MariaDbDeadLetterRepository : IDeadLetterRepository
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MariaDbDeadLetterRepository"/> class.
    /// </summary>
    ...
    public MariaDbDeadLetterRepository(Func<IDbConnection> connectionFactory, IOptionsMonitor<OutboxRuntimeOptions> options)
    {
