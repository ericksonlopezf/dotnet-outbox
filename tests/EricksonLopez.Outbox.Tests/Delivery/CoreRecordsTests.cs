...
public class CoreRecordsTests
{
    ...
    public void DeadLetterMessage_FromOutboxMessage_Should_Map_Fields_Correctly()
    {
        ...
        deadLetter.DeadLetteredAt.Should().BeCloseTo(DateTimeOffset.UtcNow, TimeSpan.FromSeconds(5));
    ...
    public void FailedMessage_FromOutboxMessage_Should_Map_Fields_Correctly_With_RetryAfter()
    {
        ...
        failed.FailedAt.Should().BeCloseTo(DateTimeOffset.UtcNow, TimeSpan.FromSeconds(5));
    ...
    public void CoreRecords_Equality_And_HashCode_Coverage()
    {
        ...
        var l2 = new Lease("o1", "node1", expiry);
        (l1 == l2).Should().BeTrue();
        ...
        // MessageEnvelope
        var me1 = new MessageEnvelope<string>("test", new OutboxMessageMetadata());
        var me2 = new MessageEnvelope<string>("test", new OutboxMessageMetadata());
